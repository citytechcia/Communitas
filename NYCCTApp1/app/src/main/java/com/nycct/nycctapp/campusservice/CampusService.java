package com.nycct.nycctapp.campusservice;

import com.nycct.nycctapp.HomeFragment;
import com.nycct.nycctapp.MainPageActivity;
import com.nycct.nycctapp.Offices.Bursar;
import com.nycct.nycctapp.Offices.registrar;
import com.nycct.nycctapp.R;
import com.nycct.nycctapp.SplashScreenActivity;
...
public class CampusService extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.campus_service_layout);
		...
		Button buttonEx0 = (Button) findViewById(R.id.button0);// gets button
		buttonEx0.setOnClickListener(new View.OnClickListener() {

			public void onClick(View v) {
				//sends user to web page
				Intent bursar_intent = new Intent(v.getContext(), Bursar.class);
				startActivity(bursar_intent);
			}
		});

		Button buttonEx1 = (Button) findViewById(R.id.button1);// gets button
		buttonEx1.setOnClickListener(new View.OnClickListener() {

			public void onClick(View v) {
				//sends user to web page
				Intent bursar_intent = new Intent(v.getContext(), registrar.class);
				startActivity(bursar_intent);
			}
		});
	}
