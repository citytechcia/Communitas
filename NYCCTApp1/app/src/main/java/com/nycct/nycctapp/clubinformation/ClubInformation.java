package com.nycct.nycctapp.clubinformation;
...
public class ClubInformation extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//THIS MUST BE FIXED
		//An infinite loop is created when this is called to something that has an intent
		if (savedInstanceState == null) {
			displayView(3); // on first time display view for first nav item
		}
		...
		buttonEx0.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Uri uri = Uri.parse("http://www.citytechcia.com");
